    ...
    <div class="card bg-warning-subtle border-0 p-3 p-md-5">
      ...
      <div class="row g-2">
        <div class="col-12 col-md-6 form-floating">
          <input type="text" name="house_structure" class="form-control" placeholder="House Structure" aria-label="House Structure" id="floating_house_structure" :value="user.household.house_structure">
          <label for="floating_house_structure" class="form-label">House Structure (e.g Apartment, Tiny House, Cabin, etc.)</label>
        </div>
        <div class="col-12 col-md-6 form-floating">
          <input type="number" min="1" name="household_members" class="form-control" placeholder="House Members" aria-label="House Members" id="floating_house_members" :value="user.household.household_members">
      ...
      <div class="row g-2 mt-2">
        ...
        <div class="col-12 col-md-6 form-floating d-none" id="number_of_children_div">
          <input type="number" min="1" name="number_of_children" class="form-control" placeholder="Number of Children" aria-label="Number of Children" id="floating_number_of_children" :value="user.household.number_of_children">
      ...
      <div class="row g-2 mt-2">
        ...
        <div class="col-12 col-md-4 form-floating d-none" id="current_pets_div">
          <input type="text" id="floating_current_pets" name="current_pets" class="form-control" placeholder="Current Pet/s" aria-label="Current Pet/s" :value="user.household.current_pets">
        ...
        <div class="col-12 col-md-4 form-floating d-none" id="number_of_current_pets_div">
          <input type="number" min="1" id="floating_number_of_current_pets" name="number_of_current_pets" class="form-control" placeholder="Number of Current Pet/s" aria-label="Number of Current Pet/s" :value="user.household.number_of_pets">
...
<script setup>
  ...
  const form = reactive({
    have_children: props.user?.household?.have_children ?? null,
    has_other_pets: props.user?.household?.has_other_pets ?? null
  })

  function submitForm(event) {
    event.preventDefault()
    const formData = new FormData(event.target)
    Inertia.put(route('households.update', user.household.id), formData)
  }
</script>
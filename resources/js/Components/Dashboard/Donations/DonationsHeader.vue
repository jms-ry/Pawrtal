<template>
  <div class="card-header border-0 bg-secondary">
    ...
    <h3 class="text-center fw-bolder display-6 font-monospace mb-4 mt-3">Manage Donations</h3>
    ...
    <div v-if="hasActiveFilters" class="mb-3">
      <div class="d-flex flex-wrap gap-2 align-items-center">
        ...
        <span v-if="filters.donation_type" class="badge bg-info text-dark d-flex flex-block align-items-center">
          Type: {{ getDonationTypeLabel(filters.donation_type) }}
...
<script setup>
  ...
  const getDonationTypeLabel = (donation_type) => {
    const labels = {
      'monetary': 'Monetary',
      'in-kind': 'In-kind'
    };
    return labels[donation_type] || donation_type;
  };

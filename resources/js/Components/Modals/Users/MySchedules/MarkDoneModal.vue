<template>
  <div class="modal fade me-2" id="markDoneModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="markDoneModalLabel" aria-hidden="true">
      ...
      <form @submit.prevent="submitForm">
        <div class="modal-body bg-info-subtle border-0">
          ...
          <div class="d-flex d-flex-row justify-content-start align-items-center mt-4">
            ...
            <p class="fw-bold font-monospace mt-2 fs-5 text-start">Mark this inspection as done?</p>
          </div>

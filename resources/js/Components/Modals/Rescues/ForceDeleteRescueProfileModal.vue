<template>
  <div class="modal fade me-2 border-rounded" id="forceDeleteRescueProfileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="forceDeleteRescueProfileModalLabel" aria-hidden="true">

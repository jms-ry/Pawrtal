<template>
  <div class="modal fade me-2 border-rounded" id="archiveRescueProfileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="archiveRescueProfileModalLabel" aria-hidden="true">
        ...
        <form @submit.prevent="submitForm" >
          <div class="modal-body bg-info-subtle border-0">
            <div class="d-flex d-flex-row justify-content-start align-items-center mt-4 display-5 p-1">
              ...
              <h4 class="fw-bold font-monospace mt-2 fs-5">Archive {{ rescue.name_formatted }}'s Profile?</h4>
            </div>
...
<script setup>
  ...
  function submitForm() {
    router.delete(`/rescues/${props.rescue.id}`, {
      ...
      onSuccess: () => {
        const modalEl = document.getElementById('archiveRescueProfileModal')

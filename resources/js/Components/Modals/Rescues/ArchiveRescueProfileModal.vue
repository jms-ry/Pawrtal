<template>
  <div class="modal fade me-2 border-rounded" id="archiveRescueProfileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteRescueProfileModalLabel" aria-hidden="true">

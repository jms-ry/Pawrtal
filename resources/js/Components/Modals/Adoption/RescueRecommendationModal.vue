<template>
  <div class="modal fade m2" id="rescueRecommendationModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="rescueRecommendationModalLabel" aria-hidden="true">
      ...
      <div class="modal-content ">
        <div class="modal-body bg-info-subtle border-0">
          <div class="d-flex d-flex-row justify-content-start align-items-center mt-4 display-5 p-1">
            ...
            <h4 class="fw-bold font-monospace mt-2 fs-5">This feature is currently unavailable!</h4>
          </div>

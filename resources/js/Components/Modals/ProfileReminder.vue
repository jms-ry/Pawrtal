      ...
      <div class="modal-content ">
        <div class="modal-body bg-info-subtle border-0">
          ...
          <div class="d-flex d-flex-row justify-content-start align-items-center display-5 p-1 mt-2 ms-4">
            <div v-if="user?.address" class="d-flex justify-content-between">
            ...
            <div v-else class="d-flex justify-content-between">
              ...
              <h4 class="fw-bold font-monospace mt-2 fs-6">Please add your address information.</h4>
            </div>
          </div>

          <div class="d-flex d-flex-row justify-content-start align-items-center display-5 p-1 mt-2 ms-4">
            <div v-if="user?.household" class="d-flex justify-content-between">
              <i class="bi bi-check2-circle me-2 text-primary fw-bold fs-2"></i>

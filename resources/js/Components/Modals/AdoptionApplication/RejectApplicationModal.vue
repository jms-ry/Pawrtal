<template>
  <div class="modal fade me-2" id="rejectApplicationModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="rejectApplicationModalLabel">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-body border-0 bg-info-subtle">
          <h3 class="fs-5 fw-bolder mt-2 text-uppercase text-center font-monospace">Reject Application</h3>
...
<script setup>
  ...
  onMounted(() => {
    ...
    rejectApplicationModal.addEventListener('show.bs.modal',(event) => {
      const button = event.relatedTarget;

      applicationId.value = button.getAttribute('data-application-id')

      console.log('Applicaiton id:', applicationId.value)
      initializeForm()
    })
  })
  ...
  function closeModal(){
    const modalEl = document.getElementById('rejectApplicationModal')

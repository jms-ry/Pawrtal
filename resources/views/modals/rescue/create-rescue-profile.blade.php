<div class="modal fade me-2" id="createRescueProfileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="createRescueModalProfileLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      ...
      <form action="{{ route('rescues.store') }}" method="POST" class="" enctype="multipart/form-data">
        @csrf
        <div class="modal-body bg-info-subtle border-0">
          <div class="row g-2 mt-2">
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_rescue_name" class="form-label">Name</label>
            </div>
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_rescue_species" class="form-label">Species</label>
            </div>
            <div class="col-12 col-md-4 form-floating">
              <input type="text" name="breed" class="form-control" placeholder="Rescue breed" aria-label="Rescue breed" id="floating_rescue_breed" >
              <label for="floating_rescue_breed" class="form-label">Breed</label>
            </div>
          </div>
          ...
          <div class="row g-2 mt-2">
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_sex" class="form-label">Select a sex</label>
            </div>
            <div class="col-12 col-md-4 form-floating">
              <input type="text" name="age" class="form-control" placeholder="Rescue age" aria-label="Rescue age" id="floating_rescue_age">
              <label for="floating_rescue_age" class="form-label">Age (e.g 6 months old)</label>
            </div>
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_rescue_size" class="form-label">Select size</label>
            </div>
          </div>
          ...
          <div class="row g-2 mt-2">
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_rescue_color" class="form-label">Color</label>
            </div>
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_rescue_distinctive_features" class="form-label">Distinctive Features</label>
            </div>
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_health_status" class="form-label">Select health status</label>
            </div>
          </div>
          ...
          <div class="row g-2 mt-2">
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_vaccination_status" class="form-label">Select vaccination status</label>
            </div>
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_spayed_neutered" class="form-label">Is it spayed/neutered?</label>
            </div>
            <div class="col-12 col-md-4 form-floating">
              ...
              <label for="floating_adoption_status" class="form-label">Select adoption status</label>
            </div>
          </div>
          ...
          <div class="row g-2 mt-2">
            ...
            <div class="col-12 col-md-6">
              <label for="images" class="form-label">Additional Image/s</label>
          ...
          <div class="row g-2 mt-2">
            <div class="col-12 form-floating">
              ...
              <label for="floating_rescue_description">Description</label>
            </div>
          </div>
        </div>

          ...
          <div class="col-12 col-md-6">
            <fieldset class="p-1">
              ...
              <div class="row g-2 mt-0">
                ...
                <div class="col-12 col-md-4">
                  <button type="button" class="btn btn-primary fw-bold w-100">Match Me a Rescue</button>
                </div>
              </div>
            </fieldset>
          </div>
          <div class="col-12 col-md-6 mt-2 mt-md-auto d-flex justify-content-end ">
            <!-- Search input for larger screens -->
            <div class="input-group w-50 h-50 d-none d-md-flex mt-auto mb-1">
              <input type="text" name="rescueSearchField" aria-label="Search" placeholder="Search..." class="form-control">

    ...
    <div class="row g-4">
      <div class="col-12 col-md-6 mt-5">
        <div class="ms-md-5 text-center text-md-start mt-3 mt-md-0">
          <h1 class="fw-bolder mt-0 mt-md-5 fs-1 ms-md-5">Welcome Back</h1>
        </div>
        <div class="ms-md-5">
        ...
        <div class="carousel slide" id="signInPetCarousel" data-bs-ride="carousel" data-bs-pause="false">
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="3000">
              <img src="{{ asset('images/sign-in/aspin-4.jpg') }}" alt="Happy pet" class="img-fluid border border-0 rounded-4 w-100">
            </div>
            <div class="carousel-item" data-bs-interval="3000">
              <img src="{{ asset('images/sign-in/aspin-2.jpg') }}" alt="Happy pet" class="img-fluid border border-0 rounded-4 w-100">
            </div>
            <div class="carousel-item" data-bs-interval="3000">
              <img src="{{ asset('images/sign-in/aspin-1.png') }}" alt="Happy pet" class="img-fill border border-0 rounded-4 w-100">
            </div>
          </div>
        </div>
      </div>
